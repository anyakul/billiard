import {createElement, renderElement} from './custom-select/utils.js';
import {createNativeSelectMarkup} from './custom-select/create-select-markup.js';
...
export class CustomSelect {
  ...
  _setSelectActiveState(multiple, insert, item) {
    const buttonTextBlock = item.querySelector('.custom-select-text');
    const activeItems = item.querySelectorAll('.custom-select-item[aria-selected="true"]');
    const label = item.querySelector('.custom-select-label');
  ...
  _onSelectElementClickAction(element, index) {
    ...
    const buttonTextBlock = parent.querySelector('.custom-select-text');
  ...
  _setSelectAction() {
    ...
    const button = this._selectElement.querySelector('.custom-select-button');
    const selectItems = this._selectElement.querySelectorAll('.custom-select-item');
